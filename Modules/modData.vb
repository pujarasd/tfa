...
Module modData
    ...
    Function dbTable(ByVal query As String) As DataTable
    ...
    Function dbupdate(ByVal qry As String) As Boolean
        Dim cmd As New SqlCommand
        ...
        Return retvalue
    End Function
    Function dbUpdate(ByVal query() As String) As Boolean
        Dim retvalue As Boolean = False
        Dim cmd As New SqlCommand
        ...
        Return retvalue
    End Function
    Function dbValue(ByVal query As String) As Object
        Dim cmd As New SqlCommand
