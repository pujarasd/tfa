Public Class Agentlist
    ...
    Private Sub stateList_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Main.miagent.Enabled = True
    End Sub
    Private Sub statelist_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Main.miagent.Enabled = False
        dgvdefault(dgv)
        dgv.Width = 417
        dgv.Columns.Add("id", "id")
        dgv.Columns.Add("Agent", "Agent")
        With dgv.Columns("id")
            .Visible = False
            .DataPropertyName = "id"
        End With
        With dgv.Columns("Agent")
            .DataPropertyName = "Agent"
            .Width = 300
        End With
        filldgv()
    ...
    Private Sub txtSearch_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtSearch.TextChanged
        ...
        If cmbSearchType.SelectedIndex = 0 Then
            dv.RowFilter = "Agent" & " like '" & txtSearch.Text.ToLower & "%'"
        Else
            dv.RowFilter = "Agent" & " like '%" & txtSearch.Text.ToLower & "%'"
        End If
    End Sub
    ...
    <string>
              select Id,Agent from mAgent order by Agent
            </string>
        dt = dbTable(query)
        dv = dt.DefaultView
        dgv.DataSource = dv
