Public Class StateList
    ...
    Private Sub statelist_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        With dgv.Columns("state")
            ...
            .Width = 300
        End With
        With dgv.Columns("country")
            .DataPropertyName = "country"
            .Width = 300
        End With
        filldgv()
        cmbColumn.Items.Add("State")
        cmbColumn.Items.Add("Country")
    ...
    Private Sub btnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEdit.Click
        If dgv.SelectedRows.Count = 0 Then
            MsgBox("Please, select State to edit", MsgBoxStyle.Information)
            Exit Sub
        End If
        Dim ofrm As New mState
        ofrm.Owner = Me
    ...
    <string>
              select a.Id,a.State,b.country from mstate a
              inner join mcountry b on a.countryid = b.id 
              order by state
            </string>
        dt = dbTable(query)
        dv = dt.DefaultView
